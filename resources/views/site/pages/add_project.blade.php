                            ...
                            <div class="tab-content">
                                <div id="menu2"
                                    ...
                                    <form class="form-horizontal" style="font-family: system-ui;"
                                        action="{{ route('project.data.store', $owner_id) }}" method="POST"
                                        ...
                                        <div class="row">
                                            <div class="col-md-2 ">
                                                ...
                                                <div class="slidecontainer">
                                                    <input id="result" name="evaluation" type="button" Value="" />
                                                </div>
                                            </div>
                                            <div class="col-md-2 ">
                                        ...
                                        <div class="row">
                                            ...
                                            <button type="submit" name="formType" value="projectRisk" class="btn">حفظ -
                                                التالي</button>
                                        </div>
                                    </form>
                                </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <label class="control-label"> التكاليف: <span
                                                        style="color: red">*</span></label>
                                                <input class="form-control" name="cost" min="0" type="number"
                                                    required>
                                            </div>
                                        </div>
                                        <div class="row">
                                ...
                                <div id="mosher"
                                    ...
                                    <form class="form-horizontal" style="font-family: system-ui;"
                                        ...
                                        <div class="row">
                                            <a href="javascript:void(0)"
                                                style="float: left;background-color: seagreen;color: white;border-radius: 6px;width: 40px;"
                                                id="addWork-btn" class="btn btn-primary" onclick="addWorkRow()"> +
                                            </a>
