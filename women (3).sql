...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 31, 2023 at 01:35 PM
...
INSERT INTO `project` (`id`, `name`, `phone`, `email`, `city`, `about`, `type_id`, `users_id`, `created_at`, `updated_at`) VALUES
(1, 'mokhtar', 102204833, 'mmelnobey92@gmail.com', 'أسوان', 'yty', 1, 1, '2023-06-15 12:21:19', '2023-06-15 12:21:19');
...
ALTER TABLE `project`
  ...
  ADD CONSTRAINT `project_ibfk_2` FOREIGN KEY (`users_id`) REFERENCES `users` (`id`);
COMMIT;
