...
function displayWelcomeMessage() {
    ...
    html +=
        "مرحبا انا سولا مساعدتك الافتراضيه <br>يمكنك أن تسألني أي شيء متعلق بأسوان<br>سأحاول أن أعطيك إجابات دقيقة<br>كيف يمكنني مساعدتك؟";
    html += "</p> </div>";
    html +=
...
document.getElementById("submit").addEventListener("click", async (e) => {
    ...
    if (!message) {
        ...
        {
            html =
                "<div class='message' id='typing'><div class='response_message'><span> ... تكتب </span></div><img src='images/sola.png' style='width: 45px; border-radius: 50%; height: 100%;'></div>";
            document.getElementById("dialog").innerHTML += html;
        }
        //post to api
        {
